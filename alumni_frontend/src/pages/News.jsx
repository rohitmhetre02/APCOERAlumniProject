  ...
  const fetchNews = async () => {
    try {
      ...
      const url = selectedCategory 
        ? `${import.meta.env.VITE_API_URL}/news?category=${selectedCategory}`
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Stay updated with the latest happenings at APCOER</p>
        </div>
        ...
        {news.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {selectedCategory ? `No articles in ${selectedCategory} category` : 'No articles available at the moment'}
            </p>
          </div>
        ) : (
              ...
              <Card key={article.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3">
                    {article.short_content || article.full_content}
                  </p>
